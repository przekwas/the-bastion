	...
	return (
		<BasePage>
			<div className="flex flex-col items-center justify-center w-full p-6 bg-gray-100 rounded">
						...
						{options && (
							<div
								...
								<div className="py-1" role="none">
									<Link
										to={{
											pathname: `/events/${details.id}/edit`,
											state: details
										}}
				...
				<DisplayRow label="estimated time">
					<div className="text-lg">{details.time}</div>
				</DisplayRow>
				{details.location_id && (
					<DisplayRow label="region">
						<div className="text-lg">{details.location_id}</div>
					</DisplayRow>
				)}
